...
{
	rsort($gzs);
	echo 'aside.appendChild(albl=lbl.cloneNode(true)),albl.appendChild(aslt=slt.cloneNode(true)),aslt.accessKey="r",aslt.id="recover",aslt.add(new Option("', $title[4], '")),aslt.firstChild.disabled=true,';
	foreach ($gzs as $gz)
	{
